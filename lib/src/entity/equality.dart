...
class IterableEquality<E> implements Equality<Iterable<E>> {
  ...
  @override
  bool notEquals(Iterable<E>? elements1, Iterable<E>? elements2) {
    return !equals(elements1, elements2);
  }
...
class ListEquality<E> implements Equality<List<E>> {
  ...
  @override
  bool notEquals(List<E>? list1, List<E>? list2) => !equals(list1, list2);
...
class MapEquality<K, V> implements Equality<Map<K, V>> {
  ...
  @override
  bool notEquals(Map<K, V>? map1, Map<K, V>? map2) {
...
class DeepCollectionEquality implements Equality {
  ...
  @override
  bool notEquals(e1, e2) => !equals(e1, e2);
...
class CaseInsensitiveEquality implements Equality<String> {
  ...
  @override
  bool notEquals(String string1, String string2) => !equals(string1, string2);
